...
| --- | --- | --- |
| CSP: Failure to Define Directive with No Fallback | Medium | 8 |
...
* URL: http://host.docker.internal:8000
  ...
  * Attack: ``
  * Evidence: `default-src 'self'; script-src 'self'; font-src 'self' fonts.gstatic.com; style-src 'self' fonts.googleapis.com`
...
* URL: http://host.docker.internal:8000
  ...
  * Parameter: `csrftoken`
  * Attack: ``
  * Evidence: `fiJnT5ApcB1uGbBxRzJtXIvMzhTMHCYz`
  * Other Info: `
cookie:csrftoken`
* URL: http://host.docker.internal:8000/volleyball/login/
  * Method: `GET`
  * Parameter: `csrftoken`
  * Attack: ``
  * Evidence: `DmDtqT9BHoIocefpHfZwnzPlL0TGfBPU`
  * Other Info: `
cookie:csrftoken`
